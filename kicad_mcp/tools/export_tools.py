...
def register_export_tools(mcp: FastMCP) -> None:
    ...
    async def refill_zones(project_path: str) -> dict[str, Any]:
        ...
        try:
            ...
            cmd = [kicad_cli, "pcb", "drc", "--output", tmp_path, "--severity-all", pcb_path]
    ...
    async def export_gerbers(project_path: str, output_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            cmd = [kicad_cli, "pcb", "export", "gerbers", "--output", output_dir, pcb_path]
            ...
            gerber_files = [
                ...
                if f.endswith((".gbr", ".gtl", ".gbl", ".gts", ".gbs", ".gto", ".gbo", ".gm1"))
            ]
    ...
    async def export_drill(project_path: str, output_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            cmd = [kicad_cli, "pcb", "export", "drill", "--output", output_dir, pcb_path]
    ...
    async def export_pos(project_path: str, output_dir: str | None = None) -> dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                "pos",
                "--output",
                os.path.join(output_dir, "pos.csv"),
                "--format",
                "csv",
                "--units",
                "mm",
